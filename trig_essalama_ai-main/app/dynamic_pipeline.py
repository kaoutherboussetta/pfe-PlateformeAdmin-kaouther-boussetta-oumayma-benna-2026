...
_GEE_TIMEOUT_SECONDS = int(os.getenv("GEE_TIMEOUT_SECONDS", "10"))
...
def _build_tunisia_places():
    """Decoupe la zone en petites zones pour traitement dynamique."""
...
def _get_indices_with_timeout(coords):
    """Recupere NDWI/NDVI avec timeout pour eviter les blocages GEE."""
...
def run_pipeline_dynamic():
    """Pipeline dynamique complet: zones + analyse IA + sauvegarde."""
    place_results = []
